...
router.post('/jurusan',authenticateToken, [
    //validation
...
router.get('/jurusan/:id',authenticateToken, function (req, res) {
...
router.patch('/jurusan/:id',authenticateToken, [
    body('nama_jurusan').notEmpty()
], (req, res) => {
    const error = validationResult(req);
    if(!error.isEmpty()){
...
router.delete('/jurusan/(:id)',authenticateToken, function(req, res){
    let id = req.params.id;
