...
router.get('/mahasiswa',authenticateToken, function (req, res){
...
router.post('/upload',authenticateToken,upload.fields([{ name: 'gambar', maxCount: 1 }, { name: 'swa_foto', maxCount: 1 }]),[
    //validation
    body('nama').notEmpty(),
    body('nrp').notEmpty(),
